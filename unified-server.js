...
app.post("/api/mockup", upload.single("logo"), async (req, res) => {
  try {
    ...
    // Return all URLs to the client immediately, but without a mockup URL yet
    // We'll generate the mockup in the background and update ActiveCampaign when it's ready
    const response = {
      success: true,
      name,
      email,
    ...
    console.log("- Mockup URL will be generated by Lambda in the background");
